...
#include "DAResidualSimpleTFoamTest.H"
...
defineTypeNameAndDebug(DAResidualSimpleTFoamTest, 0);
addToRunTimeSelectionTable(DAResidual, DAResidualSimpleTFoamTest, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAResidualSimpleTFoamTest::DAResidualSimpleTFoamTest(
      ...
      simple_(const_cast<fvMesh&>(mesh))
{
    ...
    dimensionedScalar Q("Q", dimensionSet(0,0,-1,1,0,0,0),1000),
...
void DAResidualSimpleTFoamTest::clear()
{
    /*
    Description:
...
void DAResidualSimpleTFoamTest::calcResiduals(const dictionary& options)
{
    /*
    Description:
...
void DAResidualSimpleTFoamTest::updateIntermediateVariables()
{
    /* 
    Description:
...
void DAResidualSimpleTFoamTest::correctBoundaryConditions()
{
    /* 
    Description:
